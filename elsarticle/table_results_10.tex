...
\caption{Computational results of configuration C1 for instances with 10 jobs. Literature sources: D (\citet{dos2010combination}), W (\citet{wang2014variable}), Cplex and A (\citet{ahmadian2021meta}), AB (\citet{abderrazzak2022adaptive}), and S (\citet{sabri2023reinforcement}).}
