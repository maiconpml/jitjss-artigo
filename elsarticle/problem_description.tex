...
Furthermore, for any operation $u$, we denote by $JP[u]$ and $JS[u]$ its immediate job predecessor and immediate job successor, respectively.
Similarly, for a given machine sequence $\pi$, $MP[u]$ and $MS[u]$ denote the immediate machine predecessor and immediate machine successor of operation $u$ on its assigned machine $M(u)$.
