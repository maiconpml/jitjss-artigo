...
Constraints~\eqref{eq:non_negative_start} and \eqref{eq:job_precedence} set the non-negative start times and enforce precedence among consecutive operations of the same job.
...
Metaheuristic methods for JITJSS typically decompose the solution process into two stages: exploring the sequence space metaheuristics and solving the timing sub-problem for each evaluated sequence using mathematical programming \citep{dos2010combination, wang2014variable, ahmadian2021meta}.
