...
\caption{Computational results of configuration $C_1$ for instances with 20 jobs. Literature sources: D (\citet{dos2010combination}), W (\citet{wang2014variable}), Cplex and A (\citet{ahmadian2021meta}).}
